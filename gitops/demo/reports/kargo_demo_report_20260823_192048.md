...
- Timestamp: 2026-08-23T19:20:52-05:00
- Context: kind-dev
...
project.kargo.akuity.io/k8s-deviation      True    Project is synced and ready for use   6h41m
project.kargo.akuity.io/kargo-image-demo   True    Project is synced and ready for use   13m

NAME                                             READY   STATUS                                      AGE
projectconfig.kargo.akuity.io/kargo-image-demo   True    ProjectConfig is synced and ready for use   13m

NAME                                      SHARD   AGE
warehouse.kargo.akuity.io/image-freight           13m

NAME                               SHARD   CURRENT FREIGHT   HEALTH   READY   STATUS   AGE
stage.kargo.akuity.io/dev                  N/A                        True             13m
stage.kargo.akuity.io/production           N/A                        True             13m
stage.kargo.akuity.io/staging              N/A                        True             13m

NAME                                                               ALIAS       ORIGIN (KIND)   ORIGIN (NAME)   AGE
freight.kargo.akuity.io/690a022f33e0c4bca3f166c427ac9832e5c9785a   oily-kudu   Warehouse       image-freight   13m
```
...
status:
  ...
  - lastTransitionTime: "2026-08-24T00:18:26Z"
    ...
    type: FreightCreated
  discoveredArtifacts:
    discoveredAt: "2026-08-24T00:18:25Z"
    images:
    - references:
